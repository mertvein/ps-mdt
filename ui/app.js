...
$(document).ready(() => {
  ...
  $(".profile-items").on("click", ".profile-item", async function () {
    ...
    let incidentsHTML = '<div style="color: #fff; text-align:center;">Olay Bulunmuyor</div>';
    let licencesHTML = '<div style="color: #fff; text-align:center;">Lisans Bulunmuyor</div>';
    let tagsHTML = '<div style="color: #fff; text-align:center;">Etiket Bulunmuyor</div>';
    let convHTML = '<div style="color: #fff; text-align:center;">Sicil Kaydı Bulunmuyor</div>';
    let vehHTML = '<div style="color: #fff; text-align:center;">Araç Kaydı Bulunmuyor</div>';
    let galleryHTML = '<div style="color: #fff; text-align:center;">Görsel Bulunmuyor</div>';
    let propertyHTML = '<div style="color: #fff; text-align:center;">Ev Bulunmuyor</div>';
      ...
      if (canSaveProfile == true) {
            ...
            .each(function (index) {
              if ($(this).data("id") == cid) {
                if ($(this).hasClass("green-tag")) {
                  ...
                  if ($(this).text() == "İşleme Tabii") {
                    processed = true;
                  }
                  if ($(this).text() == "İlişkilendirilmiş") {
                    isassociated = true;
                  }
                }
              }
        ...
        setTimeout(() => {
          if (canRefreshIncidents == true) {
            ...
            setTimeout(() => {
              $(".incidents-search-refresh").empty();
              $(".incidents-search-refresh").html("Yenile");
  ...
  $(".manage-incidents-title-holder").on(
    ...
    function () {
let tempalte =
        "📝 Olay Özeti:\n\n[Buraya Olayın Özetini Giriniz]\n\n🧍 Rehineler: [İsimlerini Giriniz]\n\n🔪 Ele Geçirilen Eşyalar:\n\n· [Buraya Listeyi Giriniz]\n\n-----\n💸 Ceza Tutarı:\n⌚ Karar:\n-----";
      ...
      $(".manage-incidents-title-holder").prepend(
        `
        <div class="manage-incidents-title">Olay Düzenle</div>
  ...
  $(".manage-bolos-title-holder").on(
    ...
    function () {
      ...
      $(".manage-bolos-editing-title").html(
        "Yeni bir aranan bilgisi ekliyorsun"
      );
